(* OASIS_START *)
(* DO NOT EDIT (digest: 975f486dcbf4030422eb62a3130a7f00) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("async_smtp", ["lib"], []);
          ("async_smtp_command", ["command"], []);
          ("async_smtp_tools", ["tools/lib"], [])
       ];
     lib_c = [];
     flags = [];
     includes =
       [
          ("tools/lib", ["command"; "lib"]);
          ("tools/bin", ["command"; "lib"; "tools/lib"]);
          ("sample", ["lib"]);
          ("command", ["lib"])
       ]
  }
