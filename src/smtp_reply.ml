...
let command_not_implemented_502 command =
  create `Command_not_implemented_502 !"Smtp_command not implemented: %{Smtp_command}" command
;;

let bad_sequence_of_commands_503 command =
  create `Bad_sequence_of_commands_503 !"Bad sequence of commands: %{Smtp_command}" command
;;
