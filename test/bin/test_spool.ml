...
module Fsck = struct
  ...
  let command =
    Command.group ~summary:"Widget spool fsck consistency checker."
      [ "immediate", Immediate.command
...
let command =
  Command.group ~summary:"TESTING Spool utilities."
