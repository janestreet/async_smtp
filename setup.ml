(* OASIS_START *)
(* DO NOT EDIT (digest: e3c970f53e6bcb7a470c06752399ad6d) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("async_smtp", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("async_smtp", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet-alpha/async_smtp";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Comm"; "Lexer"; "Send_mail"; "Smtp"];
                      lib_pack = true;
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "SMTP client and server";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "+\213Gm+\235R+\208\181\148\179\020\179\027\216";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
