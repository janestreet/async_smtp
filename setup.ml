(* OASIS_START *)
(* DO NOT EDIT (digest: 7a19a9eac9930b79da5ba17e4fbf5ac9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_smtp";
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("async_ssl", None);
                           FindlibPackage ("core", None);
                           FindlibPackage ("core.syntax", None);
                           FindlibPackage ("email_message", None);
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bsmtp"; "Common"; "Gc_admin"; "Spool"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "async_smtp";
                      lib_findlib_name = Some "command";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "async_smtp_tools";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("async", None);
                           InternalLibrary "async_smtp";
                           InternalLibrary "async_smtp_command";
                           FindlibPackage ("core", None);
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "sample";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "async_smtp"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "run_async_smtp.ml"});
               Executable
                 ({
                     cs_name = "add-bsmtp-header";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "tools/bin";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "async_smtp_tools"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "add_bsmtp_header.ml"
                   });
               Executable
                 ({
                     cs_name = "feeder";
                   ...
                   {exec_custom = false; exec_main_is = "feeder.ml"});
               Executable
                 ({
                     cs_name = "mbox-to-bsmtp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "mbox_to_bsmtp.ml"});
               Executable
                 ({
                     cs_name = "normalize-bsmtp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "normalize_bsmtp.ml"});
               Executable
                 ({
                     cs_name = "qstatus";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "async_smtp";
                           InternalLibrary "async_smtp_command";
                           InternalLibrary "async_smtp_tools"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "qstatus.ml"});
               Executable
                 ({
                     cs_name = "simplemail";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "simplemail.ml"});
               Executable
                 ({
                     cs_name = "stress-test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "stress_test.ml"});
               Executable
                 ({
                     cs_name = "wait-for-smtp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "wait_for_smtp.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\016\149Cm+\249K\213\129_.\187\134.Hq";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
